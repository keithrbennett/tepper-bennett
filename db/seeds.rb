...
def add_elvis_songs
  ...
  songs = [
      ...
      { code: "h-everythying" , name: "A House That Has Everything" },
      ...
      { code: "drums-islands" , name: "Drums of the Islands" },
      ...
      { code: "only-one-girl" , name: "I Love Only One Girl" },
...
def add_non_elvis_songs
  ...
  songs = [
      ...
      { code: "train-ah-choo" , name: "The Little Train Who Said 'Ah Choo" ,       performers: %w(anne-lloyd) },
...
def add_song_plays
  ...
  plays = [
      ...
      { song_code: 'h-everythying' , performer_code: 'elvis'         , youtube_key: 'oh2wVSAnv98' },
      ...
      { song_code: 'only-one-girl' , performer_code: 'elvis'         , youtube_key: 'ito_RR2kwS0' },
      ...
      { song_code: 'train-ah-choo' , performer_code: 'anne-lloyd'    , youtube_key: 'S2PFb24d2Ak' },
